...
def T_W(x, y, h, screen):
    pygame.draw.polygon(screen, LIGHTBLUE,
                        [[x, y], [x - h / math.sqrt(2), y], [x - h / math.sqrt(2), y + h], [x, y + h], [x, y]])
...
def T_C(x, y, L, CATFUR, CATEAR, CATNOSE, CATEYE, screen):
    ...
    # Ears
    pygame.draw.polygon(screen, CATFUR,
                        [[x3 - L / 4, y3 - L / 4 - 3 * L / 30], [x3 - L / 4 + 9 * L / 60, y3 - L / 4 - L / 60],
                         [x3 - L / 4 + 2 * L / 60, y3 - L / 4 + L / 9 - L / 30]])
    pygame.draw.polygon(screen, CATFUR,
                        [[x3 + L / 4, y3 - L / 4 - 3 * L / 30], [x3 + L / 4 - 9 * L / 60, y3 - L / 4 - L / 60],
                         [x3 + L / 4 - 2 * L / 60, y3 - L / 4 + L / 9 - 2 * L / 60]])

    pygame.draw.polygon(screen, CATEAR,
                        [[x3 - L / 4 + L / 30, y3 - L / 4 - L / 15], [x3 - L / 4 + 7 * L / 60, y3 - L / 4 - L / 60],
                         [x3 - L / 4 + 3 * L / 60, y3 - L / 4 + L / 9 - L / 15]])
    pygame.draw.polygon(screen, CATEAR,
                        [[x3 + L / 4 - L / 30, y3 - L / 4 - L / 15], [x3 + L / 4 - 7 * L / 60, y3 - L / 4 - L / 60],
                         [x3 + L / 4 - 3 * L / 60, y3 - L / 4 + L / 9 - L / 15]])
    ...
    pygame.draw.polygon(screen, BLACK,
                        [[x3 - L / 4, y3 - L / 4 - 3 * L / 30], [x3 - L / 4 + 9 * L / 60, y3 - L / 4 - L / 60],
                         [x3 - L / 4 + 2 * L / 60, y3 - L / 4 + L / 9 - L / 30]], 1)
    pygame.draw.polygon(screen, BLACK,
                        [[x3 + L / 4, y3 - L / 4 - 3 * L / 30], [x3 + L / 4 - 9 * L / 60, y3 - L / 4 - L / 60],
                         [x3 + L / 4 - 2 * L / 60, y3 - L / 4 + L / 9 - L / 30]], 1)
...
def T_B(x, y, h, screen):
    ...
    x = h / 12 + x
    pygame.draw.line(screen, BLACK, [x + h / 2 - 4 * h / 14, y + h / 2 + 5 * h / 12],
                     [x + h / 2 - h / 14, y + h / 2 + 2 * h / 12])
    pygame.draw.line(screen, BLACK, [x + h / 2 - 5 * h / 14, y + h / 2 + 4 * h / 12],
                     [x + h / 2 - 2 * h / 14, y + h / 2 + h / 12])
    pygame.draw.line(screen, BLACK, [x + h / 2 - 6 * h / 14, y + h / 2 + 3 * h / 12],
                     [x + h / 2 - 3 * h / 14, y + h / 2 - h / 12])
    x = x - h / 12
